...
const obj_pc = {
	...
	gear: z.object({
		trinket1: z.array(z.string()).optional(),
		trinket2: z.array(z.string()).optional(),
		leftHand: z.array(z.string()).optional(),
		rightHand: z.array(z.string()).optional(),
		head: z.array(z.string()).optional(),
		body: z.array(z.string()).optional(),
		legs: z.array(z.string()).optional(),
		feet: z.array(z.string()).optional(),
		back: z.array(z.string()).optional(),
		offHand: z.array(z.string()).optional(),
	}),
